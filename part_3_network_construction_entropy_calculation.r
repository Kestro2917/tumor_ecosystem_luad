...
# PURPOSE
# -------
# Construct a patient-specific gene co-expression network for every
# patient using LIONESS.
#
# IMPORTANT
# ---------
...
#   - KEGG
#   - Reactome
#   - any external interaction database
#
# Network information comes entirely from the expression matrix.
#
# METHOD
# ------
